...
export const CancelBookingModal: React.FC<CancelBookingModalProps> = ({
  ...
  // Always use backend API data - no client-side fallback calculation
  // This ensures backend is the single source of truth for business logic
  const isRefundEligible = eligibilityData?.data?.isRefundEligible;
  const refundMessage = eligibilityData?.data?.message || 'Unable to verify refund eligibility. Please contact support.';
